...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='woc.conf'
CONFIGFOLDER='/root/.woc'
COIN_DAEMON='wocd'
COIN_CLI='woc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/JeanLuc70/WocCoin/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
