...
#define MyAppName "Woc Core"
#define MyAppPublisher "2023 WOC Core Developers"
#define MyAppURL "https://walletofcoin.com"
#define MyAppExeName "woc-qt.exe"
#define MyAppExtraData "https://explorer.walletofcoin.com/bootstraps/WOC/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=WocSetup
SetupIconFile=.\woc.ico
Compression=lzma
SolidCompression=yes
WizardStyle=modern
DisableStartupPrompt=False
DisableWelcomePage=False
DefaultGroupName=Woc Core
...
[Files]
Source: ".\package\woc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\WocCore\Woc-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\WocCoin\Woc-Qt,strDataDir|{userappdata}\Woc\}');
  Result := True;
end;
