...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected WOC supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check WOC supply at the beginning
        # ------------------------------------------
        # WOC supply: block rewards minus burned fees for minting
        ...
        # Verify that WOC supplies were properly updated after the spends and reorgs
        self.log.info("Check WOC supply...")
