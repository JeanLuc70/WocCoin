...
"""Verify that starting woc with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start woc with -? for help text")
        ...
        self.log.info("Start woc with -version for version information")
