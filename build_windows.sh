...
# Clone code from official Github repository
	rm -rf WocCoin
	git clone https://github.com/JeanLuc70/WocCoin.git
...
# Create zip file of binaries
	cp WocCoin/src/wocd.exe WocCoin/src/woc-cli.exe WocCoin/src/woc-tx.exe WocCoin/src/qt/woc-qt.exe .
	zip WoC-Windows.zip wocd.exe woc-cli.exe woc-tx.exe woc-qt.exe
	rm -f wocd.exe woc-cli.exe woc-tx.exe woc-qt.exe
