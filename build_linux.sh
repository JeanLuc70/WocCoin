...
# Create zip file of binaries
	cp WocCoin/src/wocd WocCoin/src/woc-cli WocCoin/src/woc-tx WocCoin/src/qt/woc-qt .
	zip WoC-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip wocd woc-cli woc-tx woc-qt
	rm -f wocd woc-cli woc-tx woc-qt
