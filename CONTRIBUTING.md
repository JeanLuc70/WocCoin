Contributing to WOC Core
============================

The WOC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WOC Core project, and is not to be
confused with overall WOC Network Protocol consensus changes.

Whether a pull request is merged into WOC Core rests with the project merge
...
Patches that change WOC consensus rules are considerably more involved than
...
Where a patchset proposes to change the WOC consensus, it must have been
...
The project leader is the release manager for each WOC Core release.
