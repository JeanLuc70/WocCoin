...
# Create zip file of binaries
    cp WocCoin/src/wocd WocCoin/src/woc-cli WocCoin/src/woc-tx WocCoin/src/qt/woc-qt WocCoin/WoC-Core.dmg .
    zip WoC-MacOS.zip wocd woc-cli woc-tx woc-qt WoC-Core.dmg
    rm -f wocd woc-cli woc-tx woc-qt WoC-Core.dmg
