...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight >= 1 && nHeight < 50001)
        nSubsidy = 0.05 * COIN;
    else if (nHeight >= 50001 && nHeight < 100001)
        nSubsidy = 0.1 * COIN;
    else if (nHeight >= 100001 && nHeight < 150001)
        nSubsidy = 0.2 * COIN;
    else if (nHeight >= 150001 && nHeight < 300001)
        nSubsidy = 0.4 * COIN;
    else if (nHeight >= 300001 && nHeight < 450001)
        nSubsidy = 0.6 * COIN;
    else if (nHeight >= 450001 && nHeight < 600001)
        nSubsidy = 0.8 * COIN;
    else if (nHeight >= 600001 && nHeight < 900001)
        nSubsidy = 1 * COIN;
    else if (nHeight >= 900001 && nHeight < 1200001)
        nSubsidy = 1.5 * COIN;
    else if (nHeight >= 1200001 && nHeight < 1800001)
        nSubsidy = 2 * COIN;
    else if (nHeight >= 1800001 && nHeight < 2400001)
        nSubsidy = 3 * COIN;
    else if (nHeight >= 2400001 && nHeight < 3000001)
        nSubsidy = 2.5 * COIN;
    else if (nHeight >= 3000001 && nHeight < 3600001)
        nSubsidy = 2.1 * COIN;
    else if (nHeight >= 3600001 && nHeight < 4200001)
        nSubsidy = 1.3 * COIN;
    else if (nHeight >= 4200001 && nHeight < 4800001)
        nSubsidy = 0.7 * COIN;
    else if (nHeight >= 4800001 && nHeight < 5400001)
        nSubsidy = 0.4 * COIN;    
    else
        nSubsidy = 0.25 * COIN;

    // loose the verification to allow the initial swap emission
    if (nHeight <= 5) nSubsidy = 100000 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 WOC tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 WOC tx -> 1 confirmation
