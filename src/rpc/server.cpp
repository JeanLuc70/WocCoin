...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WOC features */
        {"woc", "listmasternodes", &listmasternodes, true },
        {"woc", "getmasternodecount", &getmasternodecount, true },
        {"woc", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"woc", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"woc", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"woc", "masternodecurrent", &masternodecurrent, true },
        {"woc", "startmasternode", &startmasternode, true },
        {"woc", "createmasternodekey", &createmasternodekey, true },
        {"woc", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"woc", "listmasternodeconf", &listmasternodeconf, true },
        {"woc", "getactivemasternodecount", &getactivemasternodecount, true },
        {"woc", "getmasternodestatus", &getmasternodestatus, true },
        {"woc", "getmasternodewinners", &getmasternodewinners, true },
        {"woc", "getmasternodescores", &getmasternodescores, true },
        {"woc", "mnsync", &mnsync, true },
        {"woc", "spork", &spork, true },
...
{
    return "> woc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18537/\n";
}
