...
/* WoC GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "WoC"
#define QAPP_ORG_DOMAIN "woc.org"
#define QAPP_APP_NAME_DEFAULT "WoC-Qt"
#define QAPP_APP_NAME_TESTNET "WoC-Qt-testnet"
